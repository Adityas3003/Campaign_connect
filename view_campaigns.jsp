    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="edit_campaign.jsp?id=<%= rs.getInt("id") %>" class="btn">Edit</a><br><br>
                    <a href="delete_campaign.jsp?id=<%= rs.getInt("id") %>" class="btn" onclick="return confirm('Are you sure?');">Delete</a>
                </td>
            </tr>
